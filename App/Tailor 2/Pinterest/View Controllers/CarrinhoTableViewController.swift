...
class CarrinhoTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
      ...
      itensDAO.getItem { (item) in
        self.label.text = String(describing: item[0].nome)
        self.descLabel.text = String(describing: item[0].dado)
        self.imageFoto.image = UIImage(named:String(describing: item[0].imagem))
      }
  ...
  /*override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    cell.imageView?.image = UIImage(named: (self.itens[indexPath.row].imagem))
